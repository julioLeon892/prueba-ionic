...
describe('HomePage', () => {
  ...
  it('should expose helpers to manage filters gracefully', () => {
    component.selectedCat = 'work';
    expect(component.isFilterActive('work')).toBeTrue();
    expect(component.isFilterActive('all')).toBeFalse();

    const spy = spyOn(component, 'onCatChange');
    component.selectFilter('work');
    expect(spy).not.toHaveBeenCalled();

    component.selectFilter('none');
